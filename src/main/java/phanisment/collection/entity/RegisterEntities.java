...
public class RegisterEntities {
	public static final EntityType<FlameSlashEntity> FLAME_SLASH = Registry.register(Registries.ENTITY_TYPE,
		...
		FabricEntityTypeBuilder.create(SpawnGroup.MISC, FlameSlashEntity::new).dimensions(EntityDimensions.fixed(0f, 0f)).build()
	);
	public static final EntityType<BlazeLeapEntity> BLAZE_LEAP = Registry.register(Registries.ENTITY_TYPE,
		...
		FabricEntityTypeBuilder.create(SpawnGroup.MISC, BlazeLeapEntity::new).dimensions(EntityDimensions.fixed(0f, 0f)).build()
	);
}