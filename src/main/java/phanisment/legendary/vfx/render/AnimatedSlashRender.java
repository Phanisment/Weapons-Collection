...
public class AnimatedSlashRenderer extends EntityRenderer<AnimatedSlashEntity> {
	...
	private static final Identifier[] SLASH_TEXTURES = {
		new Identifier(MOD_ID, "textures/vfx/slash_1.png"),
		new Identifier(MOD_ID, "textures/vfx/slash_2.png"),
		new Identifier(MOD_ID, "textures/vfx/slash_3.png"),
		new Identifier(MOD_ID, "textures/vfx/slash_4.png"),
		new Identifier(MOD_ID, "textures/vfx/slash_5.png"),
		new Identifier(MOD_ID, "textures/vfx/slash_6.png")
	};
